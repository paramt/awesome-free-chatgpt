...
|                                            🏆 赞助商 🏆                                             |
  |:------------------------------------------------------------------------------------------------:|
| 👉 [WikeAI](https://wike.ai/) 支持 OpenAI 全系模型（GPT 3.5 Trubo、GPT 4o Mini、o1 Mini 免费），支持 Claude3.5，Gemini 1.5（Gemini 1.0 免费），Llama 3，Qwen（免费）等模型。 |
